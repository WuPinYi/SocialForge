...
func (uc *UserCreate) AddInfluencerIDs(ids ...string) *UserCreate {
	uc.mutation.AddInfluencerIDs(ids...)
	return uc
}

// AddInfluencers adds the "influencers" edges to the Influencer entity.
func (uc *UserCreate) AddInfluencers(i ...*Influencer) *UserCreate {
	ids := make([]string, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
	return uc.AddInfluencerIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.InfluencersIDs(); len(nodes) > 0 {
